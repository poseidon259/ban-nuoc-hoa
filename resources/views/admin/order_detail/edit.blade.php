        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Sửa chi tiết hóa đơn</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="input_id">Mã hóa đơn</label>
                                        <input type="text" id="input_id" class="form-control" name="order_id" value="{{$data->order_id}}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
