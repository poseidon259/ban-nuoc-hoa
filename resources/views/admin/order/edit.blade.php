                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="firstname" class="form-control" name="firstname" value="{{$data->firstname}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="lastname">Tên</label>
                                        <input type="text" id="lastname" class="form-control" name="lastname" value="{{$data->lastname}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="date" class="form-control" name="date" value="{{$data->created_at}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="note">Ghi chú</label>
                                        <textarea cols="5" rows="5"class="form-control" name="note" id="note" placeholder="Ghi chú những yêu cầu đặc biệt.">{{$data->note}}</textarea>
                                    </div>
                                </div>
