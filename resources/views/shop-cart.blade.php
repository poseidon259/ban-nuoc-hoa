            ...
            <div class="d-flex justify-content-center align-items-center">
                <div class="col-6 ">
                    <div class="shoping__checkout">
                        ...
                        <ul>
                            <li>Chưa phí <span class="subtotal">-</span></li>
                            <li>Tổng tiền<span class="total">-</span></li>
                        </ul>
                        <a href="{{route('checkout')}}"><button type="submit" class="primary-btn processTotal" style="margin-top: -2rem; cursor: pointer; margin-left: 4rem;"> Thanh toán</button></a>
                    </div>
                </div>
            </div>
        </div>
